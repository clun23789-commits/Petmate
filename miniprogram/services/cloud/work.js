...
async function callWorkFunction(name, data = {}) {
    assertCloudReady();
...
async function listWorks() {
    return callWorkFunction("listWorks");
}

async function getWork(workId) {
    return callWorkFunction("getWork", { workId });
}

async function deleteWork(workId) {
    return callWorkFunction("deleteWork", { workId });
}

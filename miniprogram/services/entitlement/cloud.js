...
async function callEntitlementFunction(name, data = {}) {
  assertCloudReady();
...
async function getArEntitlement(params = {}) {
  return callEntitlementFunction("getArEntitlement", params);
}

async function grantArEntitlement(params = {}) {
  return callEntitlementFunction("grantArEntitlement", params);
}
